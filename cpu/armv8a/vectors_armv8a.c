 ...
 * IRQ entries -9 to -6 inclusive (offsets 0x1c to 0x2c of armv8a_base_t)
 * are reserved entries. */
ISR_VECTOR(0) const armv8a_base_t cortex_vector_base = {
    &_estack,
    {
        ...
        #ifdef ARMV8A_VECTOR_RESERVED_0X1C
        [6] = (isr_t)(ARMV8A_VECTOR_RESERVED_0X1C),
        #endif  /* ARMV8A_VECTOR_RESERVED_0X1C */
        #ifdef ARMV8A_VECTOR_RESERVED_0X20
        [7] = (isr_t)(ARMV8A_VECTOR_RESERVED_0X20),
        #endif  /* ARMV8A_VECTOR_RESERVED_0X20 */
        #ifdef ARMV8A_VECTOR_RESERVED_0X24
        [8] = (isr_t)(ARMV8A_VECTOR_RESERVED_0X24),
        #endif  /* ARMV8A_VECTOR_RESERVED_0X24 */
        #ifdef ARMV8A_VECTOR_RESERVED_0X28
        [9] = (isr_t)(ARMV8A_VECTOR_RESERVED_0X28),
        #endif  /* ARMV8A_VECTOR_RESERVED_0X28 */
